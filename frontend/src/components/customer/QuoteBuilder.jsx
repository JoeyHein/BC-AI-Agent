  ...
  if (isAluminium) {
    ...
    return (
      <div className="space-y-6">
        ...
        {/* Pane (insulated vs single) */}
        {isGlass && paneTypes.length > 0 && (
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-2">Pane</label>
            <div className="flex space-x-3">
              {paneTypes.map(pt => (
                <button
                  key={pt.id}
        ...
        {/* Glass type (annealed vs tempered) */}
        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            {deliveryType === 'delivery' && (
              <p className="mt-1 text-xs text-gray-400 italic">Freight is estimated. Actual shipping costs may vary based on order volume and destination.</p>
            )}
