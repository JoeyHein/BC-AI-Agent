        ...
        <defs>
          ...
          {isWoodgrain(color) && WOODGRAIN_COLORS[color] && (() => {
            ...
            if (color === 'WALNUT') {
              ...
              // French Oak: fine, gentle, nearly straight grain with short perpendicular medullary ray flecks.
              return (
                <pattern id="woodgrainPattern" patternUnits="userSpaceOnUse" width="480" height="120">
                  <rect width="480" height="120" fill={g.base} />
                  {/* Fine straight grain — subtle, close spacing */}
                  ...
                  {/* Medullary ray flecks — short perpendicular dashes characteristic of oak */}
