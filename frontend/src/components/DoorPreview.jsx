...
const COLOR_MAP = {
  ...
  FRENCH_OAK: '#A48468',          // measured from catalogue
  // Aluminum finishes
...
// Woodgrain patterns - base, light highlight, dark streak, and near-black knot color
    ...
    <div className="door-preview" style={{ display: 'inline-block' }}>
      ...
      >
        <defs>
          ...
          {/* Woodgrain pattern - horizontal grain with prominent knots, 480x120 tile */}
          {isWoodgrain(color) && WOODGRAIN_COLORS[color] && (() => {
            ...
            return (
              <pattern id="woodgrainPattern" patternUnits="userSpaceOnUse" width="480" height="120">
                ...
                {/* Long continuous dark grain streaks — varied widths and opacities */}
                ...
                {/* Light highlight streaks — wider contrast range */}
                ...
                {/* Prominent knots — dark smoke halo + near-black knot core + surrounding grain deflection */}
                {/* Knot 1 at (95, 33) */}
